...
public class NatureFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_setup_nature, container, false);
        R1 = (RadioGroup)view.findViewById(R.id.Nature);
        R2 = (RadioGroup)view.findViewById(R.id.Nature2);
        R3 = (RadioGroup)view.findViewById(R.id.Nature3);
        return view;
    }
