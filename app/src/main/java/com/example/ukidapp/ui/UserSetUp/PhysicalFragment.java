...
public class PhysicalFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        view = inflater.inflate(R.layout.fragment_setup_physical, container, false);
        R1 = (RadioGroup)view.findViewById(R.id.Physical);
        R2 = (RadioGroup)view.findViewById(R.id.Physical2);
        R3 = (RadioGroup)view.findViewById(R.id.Physical3);
        return view;
    }
