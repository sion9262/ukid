...
public class MusicFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        view = inflater.inflate(R.layout.fragment_setup_music, container, false);
        R1 = (RadioGroup)view.findViewById(R.id.Music);
        R2 = (RadioGroup)view.findViewById(R.id.Music2);
        R3 = (RadioGroup)view.findViewById(R.id.Music3);
        return view;
    }
