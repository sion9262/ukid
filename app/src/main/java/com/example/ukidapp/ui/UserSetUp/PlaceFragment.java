...
public class PlaceFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        view = inflater.inflate(R.layout.fragment_setup_place, container, false);
        R1 = (RadioGroup)view.findViewById(R.id.Place);
        R2 = (RadioGroup)view.findViewById(R.id.Place2);
        R3 = (RadioGroup)view.findViewById(R.id.Place3);
        return view;
    }
