...
public class MathFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        view = inflater.inflate(R.layout.fragment_setup_math, container, false);
        R1 = (RadioGroup)view.findViewById(R.id.Math1);
        R2 = (RadioGroup)view.findViewById(R.id.Math2);
        R3 = (RadioGroup)view.findViewById(R.id.Math3);
        return view;
    }
