...
public class RelationshipFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        view = inflater.inflate(R.layout.fragment_setup_relationship, container, false);
        R1 = (RadioGroup)view.findViewById(R.id.Relationship);
        R2 = (RadioGroup)view.findViewById(R.id.Relationship2);
        R3 = (RadioGroup)view.findViewById(R.id.Relationship3);
        return view;
    }
